    ...
    <div className="flex flex-col md:flex-row gap-8 items-center justify-center py-8">
      ...
      <div className="relative w-full max-w-[300px] drop-shadow-[4px_4px_0px_rgba(0,0,0,1)]">
        <svg viewBox="0 0 300 320" className="w-full h-auto cursor-pointer">
          ...
          <text x="150" y="90" textAnchor="middle" className="font-bold text-xs pointer-events-none">TOPO</text>
          <text x="150" y="180" textAnchor="middle" className="font-bold text-xs pointer-events-none">MEIO</text>
          <text x="150" y="280" textAnchor="middle" className="font-bold text-xs pointer-events-none">BASE</text>
        </svg>
      </div>
