...
export default function TaxacaoBlusinha() {
  return (
    <BrutalBlock title="Prioridade Fiscal: O Foco na Blusinha" theme="red">
      <p className="font-medium text-sm leading-tight">
        A “taxa das blusinhas” impacta quem depende desses produtos para economizar ou para revender
        como microempreendedor. O discurso é social, mas a prática é puramente arrecadatória.
      </p>
      ...
      <div className="border-3 border-red-600 p-4 bg-red-50 flex flex-col gap-3">
        <h4 className="font-black text-lg uppercase leading-none text-red-600">
        ...
        <div className="flex items-start gap-3 border-b-2 border-red-600 pb-2">
          ...
          <div className="flex-1">
            <span className="font-bold text-sm block">
              DÍVIDAS BILIONÁRIAS PERDOADAS (EXEMPLO):
            </span>
            ...
            <span className="text-xs italic text-gray-600 block">
              Isenções fiscais de PIS/COFINS (2023)
            </span>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3 pt-2">
          ...
          <div className="flex-1">
            <span className="font-bold text-sm block">
              ARRECADAÇÃO C/ TAXA DAS BLUSINHAS (ANUAL ESTIMADA):
            </span>
      ...
      <div className="border-l-4 border-red-600 pl-3 pt-1 pb-1">
        ...
        <p className="font-medium text-sm leading-tight italic">
          A mesma gestão aumenta imposto para o consumidor, mas perdoa dívidas bilionárias de
          empresas amigas.
        </p>
      </div>
    </BrutalBlock>
