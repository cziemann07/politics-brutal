      ...
      <div className="grid md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-4 flex flex-col gap-6">
          <div className="bg-white border-3 border-black shadow-hard p-6 relative overflow-hidden">
             ...
             <h3 className="text-xl font-black uppercase mb-4 border-b-3 border-black pb-2">O Discurso (Antes)</h3>
          ...
          <div className="bg-brutal-yellow border-3 border-black shadow-hard p-6 relative overflow-hidden">
             ...
             <div className="flex flex-col gap-1">
                ...
                <span className="text-4xl font-black tracking-tighter">R$ 315.679<span className="text-lg">,66</span></span>
             </div>
        ...
        <div className="md:col-span-8 bg-white border-3 border-black shadow-hard p-6 md:p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="text-2xl md:text-3xl font-black uppercase leading-none">A Árvore Genealógica</h3>
              <p className="text-sm font-bold text-gray-500 uppercase">Nepotismo Cruzado & Cargos no Partido</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="border-2 border-black p-3 hover:bg-black hover:text-white transition-all group cursor-crosshair">
              <div className="flex justify-between items-start">
                <span className="font-black text-lg uppercase group-hover:text-brutal-yellow">"Salsicha"</span>
            ...
            <div className="border-2 border-black p-3 hover:bg-black hover:text-white transition-all group cursor-crosshair">
              <div className="flex justify-between items-start">
                <span className="font-black text-lg uppercase group-hover:text-brutal-yellow">Sueli Lipor</span>
                <span className="bg-gray-200 text-black text-xs px-1 font-bold group-hover:bg-gray-700 group-hover:text-white">CARGO</span>
              </div>
              <p className="text-xs font-mono mt-1">Mãe de Renan Santos</p>
              <div className="mt-2 text-xs font-bold border-t border-dashed border-gray-400 group-hover:border-white pt-1">
                CARGO: Sec. Geral (BA) <span className="block text-[10px] font-normal opacity-70">*Mora em SP</span>
              </div>
            </div>
            ...
            <div className="border-2 border-black p-3 hover:bg-black hover:text-white transition-all group cursor-crosshair">
              <div className="flex justify-between items-start">
                <span className="font-black text-lg uppercase group-hover:text-brutal-yellow">Mário Jorge</span>
                <span className="bg-gray-200 text-black text-xs px-1 font-bold group-hover:bg-gray-700 group-hover:text-white">CARGO</span>
              </div>
              <p className="text-xs font-mono mt-1">Pai de Renan Santos</p>
              <div className="mt-2 text-xs font-bold border-t border-dashed border-gray-400 group-hover:border-white pt-1">
                CARGO: Pres. (RN) <span className="block text-[10px] font-normal opacity-70">*Mora em SP</span>
              </div>
            </div>
            ...
            <div className="border-2 border-black p-3 hover:bg-black hover:text-white transition-all group cursor-crosshair">
              <div className="flex justify-between items-start">
                <span className="font-black text-lg uppercase group-hover:text-brutal-yellow">Família Do Val</span>
                <span className="bg-gray-200 text-black text-xs px-1 font-bold group-hover:bg-gray-700 group-hover:text-white">CLÃ</span>
              </div>
      ...
      <div className="bg-brutal-bg border-3 border-black p-4 md:p-6 grid md:grid-cols-2 gap-8 items-center">
         <div>
            <h3 className="text-2xl font-black uppercase mb-2 flex items-center gap-2">
              ...
              O Milagre das Assinaturas
            </h3>
            <p className="font-medium text-sm mb-4">
              Como o dinheiro do fundão (que eles juraram não usar) acelerou a criação do partido em velocidade recorde.
            </p>
