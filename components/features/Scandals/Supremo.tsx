        ...
        <div className="flex flex-col items-end gap-3">
          ...
          <InstaShareButton
            data={{
              ...
              // Seção Final
              theoryQuote:
                'ÉTICA JUDICIAL "O magistrado deve evitar situações que possam comprometer a sua imparcialidade ou gerar conflito de interesses."',
        ...
        <div>
          ...
          <div className="space-y-4 font-mono text-sm dark:text-brutal-dark-text">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-bold">28 NOV:</span> Dias Toffoli é{" "}
                <span className="text-brutal-red font-bold">sorteado relator</span> do recurso do
                Banco Master no STF.
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-bold">29 NOV:</span> Viaja ao Peru em jatinho com{" "}
                <span className="font-bold">Augusto Arruda Botelho</span>, advogado de diretor do
                Master.
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-bold">03 DEZ:</span> Botelho entra com recurso no STF por seu
                cliente. <span className="text-brutal-red font-bold">No mesmo dia</span>, Toffoli
                coloca caso em <span className="font-bold">sigilo máximo</span> e traz para o STF.
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-brutal-bg dark:bg-brutal-dark-surface border-3 border-black dark:border-brutal-dark-border p-6 grid md:grid-cols-2 gap-8 items-start">
        <div>
          ...
          <p className="text-xs font-mono mt-4 p-2 bg-black text-white">
            CONTEXTO: Banco Master emitiu R$ 50 bi em CDBs sem lastro. "Desapareceu" com cerca de R$
            40 bilhões.
          </p>
        </div>
